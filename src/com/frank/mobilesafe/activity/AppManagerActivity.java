...
import com.frank.mobilesafe.dao.AppInfoProvider;
import com.frank.mobilesafe.db.bean.AppInfo;
	...
	public void onClick(View v) {
		...
		case R.id.tv_uninstall://卸载
			if (mAppInfo.isSystem) {
				ToastUtil.show(getApplicationContext(), "系统应用不能卸载", 0);
			}else {
		...
		case R.id.tv_start://打开
			...
			if(launchIntentForPackage!=null){
				...
				ToastUtil.show(getApplicationContext(), "此应用不能被开启", 0);
			}
			break;
