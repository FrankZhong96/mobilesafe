...
import com.frank.mobilesafe.dao.ProcessInfo;
...
import com.frank.mobilesafe.activity.ProcessSettingActivity;
...
//		jni  java--c   c---java
		...
		ToastUtil.show(getApplicationContext(), 
				String.format("杀死了%d进程,释放了%s空间", killProcessList.size(),totalRelease), 0);
	}
