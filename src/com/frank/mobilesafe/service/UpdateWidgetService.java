...
import com.frank.mobilesafe.receive.MyAppWidgetProvider;
...
public class UpdateWidgetService extends Service {
	...
	private void startTimer() {
		...
		}, 0, 3000);// 0s后执行，每隔3s执行一次
	}

	private void upadteAppWidget() {
		// 获取AppWidget对象
		AppWidgetManager aWM = AppWidgetManager.getInstance(this);
		// 获取窗体小部件布局转换成view对象(定位应用的包名，当前应用的布局文件)
